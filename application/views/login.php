...
<head>
  ...
  <title>Jadwal Kuliah - Login</title>
                ...
                <div class="p-5">
                 ...
                 <?= $this->session->flashdata('message'); ?>
                  ...
                  <form class="user" action="<?= base_url('auth/masuk'); ?>" method="post">
                    ...
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" placeholder="Masukkan Password" name="password" value="<?= set_value('password'); ?>">
                      <?= form_error('password'); ?>
                    </div>
